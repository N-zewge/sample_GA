...
//Problem #2
#define NX          3          /* No. of variables in func. of Problem #2 */
#define FROM        -5.12     /* start of interval for Problem #2 */
#define TO          5.12      /* end of interval for Problem #2  */
//
